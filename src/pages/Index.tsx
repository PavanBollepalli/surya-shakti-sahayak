...
import ScrollPinnedStory from '../components/sections/ScrollPinnedStory';
...
import SolarLoadingScreen from '../components/animations/SolarLoadingScreen';
...
const Index = () => {
  ...
  if (loading) {
    return <SolarLoadingScreen onComplete={() => {}} />;
  }
  ...
  return (
    <LanguageProvider>
      <div className="min-h-screen bg-white overflow-x-hidden">
        ...
        <AnimatePresence>
          {isLoading && (
            <SolarLoadingScreen onComplete={handleLoadingComplete} />
          )}
        </AnimatePresence>
          ...
          {!isLoading && (
            ...
            >
              ...
              <main>
                ...
                <CinematicHero setActiveSection={setActiveSection} />
              ...
              <AnimatePresence>
                {showScrollTop && (
                  <motion.button
                    onClick={scrollToTop}
                    className="fixed bottom-8 right-8 bg-gradient-to-r from-solar-yellow to-leaf-green text-white p-4 rounded-full shadow-2xl hover:shadow-3xl transition-all z-50"
